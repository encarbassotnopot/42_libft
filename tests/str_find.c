...
/*   Updated: 2024/06/11 15:53:09 by ecoma-ba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	int		errors;
	char	*names[] = {"ft_memchr", "ft_strchr", "ft_strrchr", "ft_memcmp", "ft_strncmp", "ft_strnstr", "ft_atoi"};

	void (*mine[])() = {ft_memchr, ft_strchr, ft_strrchr, ft_memcmp, ft_strncmp, ft_strnstr, ft_atoi};
